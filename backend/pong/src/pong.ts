...
let bg: string = "green";
let p1Col: string = "red";
let p2Col: string = "yellow";
let uiCol = "white";
...
class Paddle {
	...
	private _del: number = 0;
	private _goTime: number = 0;
	private _moveSpeed = canvas.height / 400;
	...
	public go(go: number) {this._goTime = go;}
	public stop() {clearTimeout(this._goTime);}
	public getPosY() {return this._posY;}
	public getPosX() {return this._posX;}
	public getMoveSpeed() {return this._moveSpeed;}
...
class Ball {
	...
	public setDirX(dir: number) {this._dirX = dir;}
	public setDirY(dir: number) {this._dirY = dir;}
